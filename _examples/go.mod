...
replace (
	...
	github.com/lynx-go/lynx/contrib/cluster => ../contrib/cluster
	...
	github.com/lynx-go/lynx/contrib/watermill => ../contrib/watermill
	github.com/lynx-go/lynx/contrib/watermill-kafka => ../contrib/watermill-kafka
