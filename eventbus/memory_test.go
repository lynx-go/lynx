...
func TestMemoryBusPublishSubscribe(t *testing.T) {
	...
	if err := b.Subscribe(context.Background(), "order.created", "h1", func(ctx context.Context, e *RawEvent) error {
		received <- e
		return nil
	}); err != nil {
	...
	if err := SubscribeTyped(context.Background(), b, topic, "h2", func(ctx context.Context, e *Event[map[string]string]) error {
		typedReceived <- e
		return nil
	}); err != nil {
	...
	if err := b.Subscribe(context.Background(), "order.created", "h3", func(ctx context.Context, e *RawEvent) error {
		count.Add(1)
		return nil
	}); err != nil {
...
func TestMemoryBusWithAppContext(t *testing.T) {
	...
	_ = b.Subscribe(context.Background(), "test", "h", func(ctx context.Context, e *RawEvent) error {
		done <- struct{}{}
		return nil
	})
	time.Sleep(20 * time.Millisecond)
